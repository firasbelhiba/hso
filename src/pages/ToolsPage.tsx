...
const ToolsPage: React.FC = () => {
  ...
  const [animatedSquares, setAnimatedSquares] = useState<Set<string>>(
    new Set()
  );
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      for (let i = 0; i < squaresToAnimate; i++) {
        const randomSquare =
          allSquares[Math.floor(Math.random() * allSquares.length)];
  ...
  const aiCodeHelpers: Tool[] = [
    {
      name: "Cursor",
      description:
        "AI-powered code editor with intelligent completion and chat interface",
    ...
    },
    {
      name: "Bolt",
      description:
        "AI-powered full-stack web development platform for rapid prototyping",
    ...
    },
    {
      name: "v0 by Vercel",
      description:
        "AI-powered UI generation tool that creates React components from text descriptions",
    ...
    },
    {
      name: "ChatGPT",
      description:
        "Versatile AI assistant for code review, debugging, and programming help",
    ...
    },
    {
      name: "Claude",
      description:
        "Advanced AI assistant with strong coding capabilities and code analysis",
  ...
  const hederaTrackTools = {
    1: {
      ...
      description:
        "Leveraging DLT to enhance financial systems in Africa, emphasizing accessibility, transparency, and asset management.",
      useCases: [
      ...
      coreTools: [
        {
          ...
          description:
            "For tokenizing assets like real estate, commodities, and stablecoins",
          featured: true,
          website:
            "https://docs.hedera.com/hedera/sdks-and-apis/sdks/token-service",
        },
        {
          name: "Hedera Smart Contract Service (HSCS)",
          description:
            "For deploying DeFi systems, including lending protocols and DEXs",
          featured: true,
          website: "https://hedera.com/smart-contract",
        },
        {
          name: "Hedera Consensus Service (HCS)",
          description:
            "For logging secure and transparent transactions with immutable records",
          website:
        ...
        },
        {
          name: "Mirror Nodes",
          description:
            "For efficient querying of blockchain data and real-time transaction monitoring",
          website: "https://docs.hedera.com/hedera/core-concepts/mirror-nodes",
        },
        {
          name: "JSON-RPC Relay",
          description:
            "Enables EVM-compatible integrations with Web3.js or Ethers.js",
          website:
        ...
        },
        {
          name: "Hedera SDKs",
          description:
            "For building custom finance dApps and integrating with wallets like HashPack",
          website: "https://docs.hedera.com/hedera/sdks-and-apis/sdks",
        },
      ],
      ecosystemProjects: [
        ...
        {
          name: "Stader",
          description: "Staking and liquid staking derivatives in RWAs",
        },
        {
          name: "Bonzo",
          description: "DeFi platform on Hedera for financial services",
    ...
    2: {
      ...
      description:
        "Applying Hedera's DLT to optimize operational sectors, improving efficiency, transparency, and sustainability.",
      useCases: [
      ...
      coreTools: [
        {
          name: "Hedera Token Service (HTS)",
          description:
            "Facilitate secure transactions across healthcare, agriculture, and supply chains",
          featured: true,
          website:
            "https://docs.hedera.com/hedera/sdks-and-apis/sdks/token-service",
        },
        {
          name: "Hedera Smart Contract Service (HSCS)",
          description:
            "Automating business processes like payments, logistics, and compliance",
          featured: true,
          website: "https://hedera.com/smart-contract",
        },
        {
          name: "Hedera Consensus Service (HCS)",
          description:
            "Provide immutable transaction ordering and enhance transparency",
          website:
            "https://docs.hedera.com/hedera/sdks-and-apis/sdks/consensus-service",
        },
        {
          ...
          description:
            "Decentralized file storage for patient records or supply chain documents",
          website:
            "https://docs.hedera.com/hedera/sdks-and-apis/sdks/file-service",
        },
        {
          name: "Mirror Nodes",
          description:
            "Real-time querying of transaction data for supply chain traceability",
          website: "https://docs.hedera.com/hedera/core-concepts/mirror-nodes",
        },
        {
          name: "Hedera SDKs",
          description:
            "Integrating operational dApps with external systems like IoT",
          website: "https://docs.hedera.com/hedera/sdks-and-apis/sdks",
        },
      ],
      ecosystemProjects: [
        {
          name: "Dovu",
          description:
            "Carbon credits and sustainability tracking in supply chains",
        },
        {
          name: "Chainlink Oracles",
          description:
            "Real-world data feeds for operations via Hedera's EVM compatibility",
        },
        {
          name: "Hedera Guardian",
          description:
            "Open-source platform for digital environmental assets and sustainability tracking",
          website: "https://github.com/hashgraph/guardian",
        },
      ],
    },
    3: {
      ...
      description:
        "Exploring immersive digital experiences, play-to-earn models, metaverses, and community-driven economies.",
      useCases: [
      ...
      ecosystemProjects: [
        {
          ...
          description: "Metaverse development via SDKs",
        },
      ],
    },
    4: {
      ...
      coreTools: [
        ...
        {
          name: "Hedera Smart Contract Service (HSCS)",
          description: "Automating actions in DePIN with AI logic integration",
          website: "https://hedera.com/smart-contract",
        },
        {
          name: "JSON-RPC Relay",
          description: "EVM-compatible AI integrations for cross-network DePIN",
          website:
            "https://docs.hedera.com/hedera/core-concepts/smart-contracts/json-rpc-relay",
        },
        {
      ...
      aiTools: [
        {
          ...
          description:
            "Build Hedera-powered AI agents in under a minute with LangChain, Vercel AI SDK, or MCP",
          website: "https://www.npmjs.com/package/hedera-agent-kit",
        },
        {
          name: "AI Studio",
          description:
      ...
      ecosystemProjects: [
        {
          name: "OpenConvAI",
          description:
            "Advanced conversational AI platform for building intelligent chat applications on Hedera",
          website: "https://hashgraphonline.com",
        },
      ],
    },
  ...
  const toolCategories = [
    ...
    },
    {
      ...
      tools: [
        {
          name: "React Native",
          description: "Framework for building mobile apps using React",
        ...
        {
          name: "SwiftUI",
          description: "Modern UI framework for iOS development",
    ...
    },
    {
      ...
      tools: [
        ...
        },
        {
          name: "Vercel",
          description:
            "Frontend cloud platform for static sites and serverless functions",
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <Link to="/tools" className="nav-link text-sm text-blue-400">
                Tools
              </Link>
              <Link to="/media-kit" className="nav-link text-sm">
                Media Kit
              </Link>
              <Link to="/rules" className="nav-link text-sm">
                Rules
              </Link>
      ...
      <div className="pt-24 pb-16 px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <h1
            className="text-4xl md:text-6xl font-bold text-black mb-6 tracking-wider"
            style={{ fontFamily: "Archivo, sans-serif" }}
          >
            DEVELOPER <span style={{ color: "#0350F3" }}>TOOLS</span>
          </h1>
          <p className="text-gray-700 text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Discover the essential tools and technologies that power modern
            development. From AI-powered code assistants to cutting-edge
            frameworks.
          </p>
          ...
          <div className="bg-black/90 backdrop-blur-sm p-6 max-w-2xl mx-auto mb-8 font-mono text-left">
            ...
            <div className="text-green-400 text-sm">
              ...
              <span className="text-yellow-400">awesome-tools</span>
              <br />
              <span className="text-gray-400">
                ✓ Installing developer productivity tools...
              </span>
              <br />
              <span className="text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Discover track-specific Hedera tools and ecosystem projects for
            ...
            <div className="bg-gray-900/80 backdrop-blur-sm p-4 max-w-xl mx-auto font-mono text-left">
              ...
              <div className="text-green-400 text-xs">
                <span className="text-blue-400">$</span> hedera init --track=
                {activeTrack}
                <br />
                <span className="text-gray-400">
                  ✓ Loading track-specific tools...
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 p-8 border border-blue-500/20">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-white">
                      {hederaTrackTools[activeTrack].sponsor.name}
                    </h4>
                    <p className="text-gray-300 text-sm">
                      {hederaTrackTools[activeTrack].sponsor.description}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {hederaTrackTools[activeTrack].useCases.map(
                  (useCase, index) => (
                    <div
                      key={index}
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {hederaTrackTools[activeTrack].coreTools.map((tool, index) => (
                  <div
                    key={index}
                    className={`bg-gray-800/80 p-6 border-2 transition-all duration-300 hover:scale-105 border-gray-600 hover:border-blue-400 ${
            ...
            {hederaTrackTools[activeTrack].aiTools && (
              <div className="mb-10">
                <h4 className="text-xl font-bold text-blue-400 mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {hederaTrackTools[activeTrack].aiTools.map((tool, index) => (
                    <div
                      key={index}
                      className={`bg-gray-800/80 p-6 border-2 transition-all duration-300 hover:scale-105 border-gray-600 hover:border-blue-400 ${
                        tool.website ? "cursor-pointer" : ""
            ...
            {/* Ecosystem Projects */}
            {hederaTrackTools[activeTrack].ecosystemProjects && (
              <div>
                <h4 className="text-xl font-bold text-blue-400 mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {hederaTrackTools[activeTrack].ecosystemProjects.map(
                    (project, index) => (
                      <div
                        key={index}
            ...
            <div className="mt-10 bg-black/50 p-6 font-mono text-sm">
              <div className="text-gray-400 mb-3">
                // Quick start for Track {activeTrack}
              </div>
              <div className="text-green-400">
                <span className="text-blue-400">import</span>{" "}
                {`{ Client, TokenCreateTransaction }`}{" "}
                <span className="text-blue-400">from</span>{" "}
                <span className="text-orange-400">"@hashgraph/sdk"</span>;<br />
                <span className="text-blue-400">const</span> client =
                Client.forTestnet();
                <br />
                <span className="text-gray-400">
                  // Build your Track {activeTrack} solution!
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-center mb-6">
              <h2
                className="text-4xl md:text-5xl font-bold text-black tracking-wider"
                style={{ fontFamily: "Archivo, sans-serif" }}
              >
            ...
            <p className="text-gray-700 text-lg md:text-xl max-w-3xl mx-auto">
              Supercharge your development workflow with AI-powered coding
              assistants
            </p>
          </div>
            ...
            {aiCodeHelpers.map((tool, index) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span
                    className={`text-sm font-semibold px-2 py-1 ${getPricingColor(
                      tool.pricing
                    )}`}
                  >
                    {tool.pricing}
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-500 text-sm bg-gray-100 px-2 py-1">
                    {tool.category}
                  </span>
                  <a
                    href={tool.website}
      ...
      <div className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2
              className="text-4xl md:text-5xl font-bold text-black mb-6 tracking-wider"
              style={{ fontFamily: "Archivo, sans-serif" }}
            >
            ...
            <div className="bg-black/90 backdrop-blur-sm p-4 max-w-xl mx-auto font-mono text-left">
              ...
              <div className="text-green-400 text-xs">
                <span className="text-blue-400">$</span> cat categories.json |
                grep -E "(framework|sdk|tool)"
                <br />
                <span className="text-gray-400">
                  ✓ Found{" "}
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: category.special
                        ? category.color
                        : category.color,
                    }}
                  >
                  ...
                  {category.tools.map((tool, toolIndex) => (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <span
                          className={`text-xs font-semibold px-2 py-1 ${getPricingColor(
                            tool.pricing
                          )}`}
                        >
                          {tool.pricing}
                ...
                {category.special && (
                  <div className="mt-8 bg-black/50 p-4 font-mono text-sm">
                    ...
                    <div className="text-green-400">
                      ...
                      .forTestnet();
                      <br />
                      <span className="text-blue-400">const</span> accountId ={" "}
                      <span className="text-orange-400">"0.0.123456"</span>;
                      <br />
                      <span className="text-gray-400">
      ...
      <section className="py-20 bg-black relative">
        <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
          ...
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of developers using these tools to build the future
